...
/**
 * LoadingElement - A versatile loading spinner component
 ...
 * @param {string} [props.variant='spinner'] - Spinner variant (spinner, dots, pulse)
 * @param {boolean} [props.overlay=false] - Whether to show overlay background
 * @param {boolean} [props.fullScreen=false] - Whether to cover the full screen
 * @param {string} [props.className] - Additional CSS classes
 * @returns {JSX.Element} Rendered LoadingElement component
 */
export default function LoadingElement({
  ...
  return (
    <div className={containerClasses}>
      ...
      {text && (
        <span
          className={clsx('mt-4 text-sm font-medium', colorMap[color])}
        >
          {text}
        </span>
      )}
